...
class Item(models.Model):
    ...
    instructions = models.CharField(max_length=250,default="Cash on delivery Option Available")
    image = models.ImageField(default='default.png', upload_to='images/')
    labels = models.CharField(max_length=25, choices=LABELS, blank=True, null=True)
    label_colour = models.CharField(max_length=15, choices=LABEL_COLOUR, blank=True, null=True)
